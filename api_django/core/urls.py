...
from .views import (
    ...
    AdminConfigTemplateDetailView,
    AdminConfigTemplateListCreateView,
...
urlpatterns = [
    ...
    path('processos/<int:id_processo>/minuta/download/', ProcessoMinutaDownloadView.as_view(), name='processo-minuta-download'),
    ...
    path('admin/usuarios/', AdminConfigUsuarioListCreateView.as_view(), name='admin-usuarios'),
    path('admin/usuarios/<int:id_usuario>/', AdminConfigUsuarioDetailView.as_view(), name='admin-usuario-detail'),
    ...
    path('admin/documentos/', AdminConfigDocumentoListCreateView.as_view(), name='admin-documentos'),
    path('admin/documentos/<int:id_tipo_documento>/', AdminConfigDocumentoDetailView.as_view(), name='admin-documento-detail'),
    ...
    path('admin/config/templates/', AdminConfigTemplateListCreateView.as_view(), name='admin-config-templates'),
    path('admin/config/templates/<int:id_template>/', AdminConfigTemplateDetailView.as_view(), name='admin-config-template-detail'),
]
